...
<nav class="navbar navbar-default" role="navigation">
	...
	<div>
		<ul class="nav navbar-nav">
			<li class="active"><a href="travelupdate.jsp" style="font-size: 150%;">&nbsp; 修改</a></li> &nbsp;
				...
				<!--个人信息-->	
					<div id="myinfo">
						...
						<div class="form-group">
							 <label for="exampleInputUserName">旅游标题</label><input type="text" class="form-control" id="exampleInputUserName" />
						</div>
                          <div class="form-group">
                           <table>
							<tr> 
								<td><button type="button" class="picture">重新上传图片</button></td>
                    ...
                    <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="form-group">
							 <label for="exampleInputDay">出发日期</label><input type="password" class="form-control" id="exampleInputDay" />
						</div>
