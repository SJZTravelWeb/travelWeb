...
<nav class="navbar navbar-default" role="navigation">
	...
	<div>
		<ul class="nav navbar-nav">
			<li class="active"><a href="userupdate.jsp" style="font-size: 150%;">&nbsp;修改</a></li> &nbsp;
				...
				<!--个人信息-->	
					<div id="myinfo">
						...
						<div class="form-group">
							 <label for="exampleInputUserName">用户名</label><input type="text" class="form-control" id="exampleInputUserName" />
						</div>
                    ...
                    <div class="form-group">
							 <label for="exampleInputtimeDay">注册时间</label><input type="text" class="form-control" id="exampleInputtimeDay" />
						</div>
                          ...
                          <div class="form-group">
							...
							<div class="form-group">
							 <label for="exampleInputIDcard">身份证号</label><input type="text" class="form-control" id="exampleInputIDcard" />
						</div>
